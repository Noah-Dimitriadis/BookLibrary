#!/usr/bin/env python3
# disk-monitor.py
# Purpose: disk usage monitoring script
#
# USAGE: ./disk-monitor.py
#
# Author: *** Oliver Chan***
# Date: *** July 5 2022 ***
...
parser.add_argument("sendto",help="Enter username to send mail to: ")
parser.add_argument("limit",help="Enter alert limit: ")
