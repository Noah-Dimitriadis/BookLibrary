...
try:
    ...
    # Open and read file
    f = open("hosts_prep.txt", "r")
    content1 = f.read()
    print(content1)
    f.close()
   
    # writing to /etc/hosts file(using /hostfiles/hosts_final.txt as a testing directory)
    f2 = open('/home/ochan10/hostfiles/hosts_final.txt', "w")
    f2.write(content1)
    f2.close()

    # printing new content of final.txt - using final.txt as hosts file instead of /etc/hosts
    print("\nNew content of /etc/hosts file\n**********************************")
    f2 = open('/home/ochan10/hostfiles/hosts_final.txt', "r")
    print(f2.read())
    f2.close()
